// // ReactDOM.render(<p>Fun facts about react</p>, document.getElementById('root'))
// // ReactDOM.render(<ul><li>car brand</li><li>car price</li></ul>, document.getElementById('root'))
